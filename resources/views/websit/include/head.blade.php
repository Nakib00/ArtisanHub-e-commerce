...
<head>
	...
	{{--  <!-- favicon -->  --}}
	<link rel="shortcut icon" type="image/png" href="{{asset('siteAssets/img/favicon.png')}}">
	{{--  <!-- google font -->  --}}
	...
	{{--  <!-- bootstrap -->  --}}
	<link rel="stylesheet" href="{{asset('siteAssets/bootstrap/css/bootstrap.min.css')}}">
	{{--  <!-- owl carousel -->  --}}
	...
	{{--  <!-- mean menu css -->  --}}
	<link rel="stylesheet" href="{{asset('siteAssets/css/meanmenu.min.css')}}">
	{{--  <!-- main style -->  --}}
	<link rel="stylesheet" href="{{asset('siteAssets/css/main.css')}}">
	{{--  <!-- responsive -->  --}}
